...
class DBStorage:
    ...
    def get(self, cls, id):
        ...
        obj_val = self.__session.query(cls).filter(cls.id == id).all()
        return (None if len(obj_val) == 0 else obj_val[0])
    ...
    def count(self, cls=None):
        ...
        if cls:
            ...
            no_of_all = 0
            for ele in classes.values():
                no_of_all += self.__session.query(ele).count()
            return (no_of_all)
